...
describe('write_file tool', () => {
  ...
  it('creates a new file', async () => {
    ...
    expect(result.displayContent).toContain('--- /dev/null')
    expect(result.displayContent).toContain('+hello world')
  ...
  it('overwrites an existing file', async () => {
    ...
    expect(result.content).not.toContain('diff --git')
    expect(result.displayContent).toContain('diff --git')
    expect(result.displayContent).toContain('-old content')
    expect(result.displayContent).toContain('+new content')
